...
async def start(bot, m: Message):
    ...
    start_message = await bot.send_photo(
        chat_id=m.chat.id,
        photo="https://i.postimg.cc/jj2f6ttY/backiee-230452-landscape.jpg",
        caption=caption
    )
...
async def back_to_main_menu(client, callback_query):
    ...
    await callback_query.message.edit_media(
      InputMediaPhoto(
        media="https://i.postimg.cc/pT8MFMF2/backiee-330776-landscape.jpg",
        caption=caption
      ),
...
async def help_button(client, callback_query):
  ...
  await callback_query.message.edit_media(
    InputMediaPhoto(
      media="https://i.postimg.cc/02kh8wc5/backiee-218350-landscape.jpg",
      caption=caption
    ),
    reply_markup=keyboard
    )
...
async def settings_button(client, callback_query):
    ...
    await callback_query.message.edit_media(
    InputMediaPhoto(
      media="https://i.postimg.cc/jj2f6ttY/backiee-230452-landscape.jpg",
      caption=caption
    ),
    reply_markup=keyboard
    )
...
async def cancel_handler(client: Client, m: Message):
    if m.chat.id not in AUTH_USERS:
        ...
        if globals.processing_request:
            ...
            await asyncio.sleep(15)  # 30 second wait
